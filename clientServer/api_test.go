...
func TestGetHolidayRequest(t *testing.T) {
	...
	var tests = []Test{
		...
		{input: HolidayRequest{Day: "22", Month: "2", Year: "2222"}, want: Holiday{Name: "Not Holiday", Description: ""}},
		{input: HolidayRequest{Day: "35", Month: "1", Year: "1234"}, want: Holiday{Name: "Not Holiday", Description: ""}}}
